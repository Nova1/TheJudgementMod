...
public class EntityAIVillagerMate extends EntityAIBase
{
    ...
    private EntitymodVillager mate;
    private World worldObj;
    private int matingTimeout;
    Village villageObj;
    private static final String __OBFID = "CL_00001594";

    public EntityAIVillagerMate(EntitymodVillager par1EntityVillager)
    {
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    this.mate = (EntitymodVillager)entity;
    ...
    {
    	EntitymodVillager entityvillager = this.villagerObj.createChild(this.mate);
